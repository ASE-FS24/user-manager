...
awslocal dynamodb put-item --table-name UserInfo --item '{
    ...
    "username": {"S": "AlexTheAdvocate"},
    "firstName": {"S": "Alex"},
    "lastName": {"S": "Johnson"},
    "birthday": {"S": "1993-05-24"},
    "bio": {"S": "Passionate about mental health advocacy and community projects."},
    "university": {"S": "University of Life"},
    "degreeProgram": {"S": "Psychology"}
}'
